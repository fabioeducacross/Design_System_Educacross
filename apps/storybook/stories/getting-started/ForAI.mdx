...
```tsx
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter, Button } from "@educacross/ui";
...
```tsx
import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell, Pagination } from "@educacross/ui";
...
**Causa:** `@educacross/ui/styles.css` não importado.
...
content: [
  "./src/**/*.{ts,tsx}",
  "./node_modules/@educacross/ui/dist/**/*.{js,mjs}", // ← Adicionar
]
```
