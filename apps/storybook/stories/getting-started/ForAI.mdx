...
```tsx
import { Button, Input, Label, Card, CardHeader, CardTitle, CardContent } from "@fabioeducacross/ui";
...
```tsx
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter, Button } from "@fabioeducacross/ui";
...
```tsx
import { Table, TableHeader, TableBody, TableRow, TableHead, TableCell, Pagination } from "@fabioeducacross/ui";
...
**Causa:** `@fabioeducacross/ui/styles.css` não importado.
...
content: [
  "./src/**/*.{ts,tsx}",
  "./node_modules/@fabioeducacross/ui/dist/**/*.{js,mjs}", // ← Adicionar
]
```
...
pnpm remove @fabioeducacross/ui
...
- [ ] Importar de `@fabioeducacross/ui`
